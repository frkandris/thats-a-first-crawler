...
- [build-request-node](/project/build-request-node.md) — normalization, dedup, hashtag deltas, DeepSeek request.
...
- [credentials](/project/credentials.md) — Apify / DeepSeek / Gmail credentials.
...
- [deepseek-api](/tech/deepseek-api.md) — OpenAI-compatible chat API, JSON mode and its limits, models & pricing.
